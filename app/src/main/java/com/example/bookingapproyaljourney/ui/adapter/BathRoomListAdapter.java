...
public class BathRoomListAdapter extends RecyclerView.Adapter<BathRoomListAdapter.ViewHoler> {
    private List<Bathroom> bathroomList;
    private Context context;

    public BathRoomListAdapter(List<Bathroom> bathroomList, Context context) {
    ...
    public ViewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_bathroombottomsheet,parent,false);
